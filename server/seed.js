...
const demoUsers = [
  { id: "user-farmer1", username: "farmer1", role: "farmer", display_name: "Ganesh Pawar", phone: "9822010001", location: "Niphad, Nashik" },
  { id: "user-farmer2", username: "farmer2", role: "farmer", display_name: "Suresh Chavan", phone: "9822010002", location: "Lasalgaon, Nashik" },
  { id: "user-fpo1", username: "fpo1", role: "fpo", display_name: "Nashik Onion Producer Co. Ltd", phone: "9822010010", location: "Niphad, Nashik" },
  { id: "user-buyer1", username: "buyer1", role: "buyer", display_name: "Maharashtra Agro Foods Pvt Ltd", phone: "9822010020", location: "Pune" },
  { id: "user-buyer2", username: "buyer2", role: "buyer", display_name: "FreshChain Retail", phone: "9822010021", location: "Mumbai" },
  { id: "user-admin1", username: "admin1", role: "admin", display_name: "MSIS Market Authority Desk", phone: "9822010099", location: "Mumbai" },
];
...
// ---------------- MARKETS ----------------
const marketsList = [
  { id: "mkt-lasalgaon", name: "Lasalgaon APMC", district: "Nashik" },
  { id: "mkt-pimpalgaon", name: "Pimpalgaon Baswant APMC", district: "Nashik" },
  { id: "mkt-manmad", name: "Manmad APMC", district: "Nashik" },
  { id: "mkt-pune", name: "Pune (Market Yard) APMC", district: "Pune" },
  { id: "mkt-solapur", name: "Solapur APMC", district: "Solapur" },
  { id: "mkt-sangli", name: "Sangli APMC", district: "Sangli" },
  { id: "mkt-kolhapur", name: "Kolhapur APMC", district: "Kolhapur" },
  { id: "mkt-nagpur", name: "Nagpur APMC (Kalamna)", district: "Nagpur" },
  { id: "mkt-ahilyanagar", name: "Ahilyanagar APMC", district: "Ahilyanagar" },
  { id: "mkt-aurangabad", name: "Chhatrapati Sambhajinagar APMC", district: "Aurangabad" },
];
...
insFarmer.run("farmer-1", "user-farmer1", "Ganesh Pawar", "Niphad", "Nashik", "fpo-1", 4.5, "9822010001");
insFarmer.run("farmer-2", "user-farmer2", "Suresh Chavan", "Lasalgaon", "Nashik", "fpo-1", 2.8, "9822010002");
const extraFarmerNames = [
  "Vitthal Jadhav", "Kailas Shinde", "Ramesh Gaikwad", "Baban Wagh", "Dnyaneshwar More",
  "Ashok Kale", "Prakash Bhosale", "Nitin Sonawane", "Sanjay Deshmukh", "Anil Kharat",
];
for (let i = 0; i < extraFarmerNames.length; i++) {
  insFarmer.run(`farmer-extra-${i}`, null, extraFarmerNames[i], "Niphad", "Nashik", "fpo-1", 1.5 + rand() * 5, `98220${11000 + i}`);
}

// ---------------- FPO ----------------
const insFpo = db.prepare(`INSERT INTO fpos (id, user_id, name, district, registration_no, member_count, contact) VALUES (?,?,?,?,?,?,?)`);
insFpo.run("fpo-1", "user-fpo1", "Nashik Onion Producer Co. Ltd", "Nashik", "FPO/MH/2019/1042", 42, "9822010010");
...
const buyersList = [
  { id: "buyer-1", user_id: "user-buyer1", name: "Maharashtra Agro Foods Pvt Ltd", type: "Processor", location: "Pune", verified: 1, docs: 1, txns: 58, pay: 96, resp: 91 },
  { id: "buyer-2", user_id: "user-buyer2", name: "FreshChain Retail", type: "Retail chain", location: "Mumbai", verified: 1, docs: 1, txns: 34, pay: 89, resp: 84 },
  { id: "buyer-3", user_id: null, name: "Sahyadri Exports LLP", type: "Exporter", location: "Nashik", verified: 1, docs: 1, txns: 21, pay: 93, resp: 78 },
  { id: "buyer-4", user_id: null, name: "Deccan Wholesale Traders", type: "Wholesaler", location: "Solapur", verified: 1, docs: 0, txns: 12, pay: 81, resp: 70 },
  { id: "buyer-5", user_id: null, name: "AgriBazaar Digital Trading", type: "Digital trader", location: "Pune", verified: 1, docs: 1, txns: 145, pay: 97, resp: 95 },
  { id: "buyer-6", user_id: null, name: "Vidarbha Institutional Supplies", type: "Institutional buyer", location: "Nagpur", verified: 0, docs: 0, txns: 4, pay: 75, resp: 60 },
];
...
const storageList = [
  { id: "store-1", name: "Nashik District Warehousing Corp - Niphad", location: "Niphad", district: "Nashik", cap: 5000, avail: 1800, cost: 1.2, crops: "Onion,Wheat,Maize" },
  { id: "store-2", name: "Lasalgaon Cold Storage & Godown", location: "Lasalgaon", district: "Nashik", cap: 3000, avail: 900, cost: 1.5, crops: "Onion,Grapes" },
  { id: "store-3", name: "Pune Rural Godown Facility", location: "Pune", district: "Pune", cap: 4000, avail: 2200, cost: 1.1, crops: "Tomato,Onion,Soybean" },
  { id: "store-4", name: "Solapur APMC Warehouse", location: "Solapur", district: "Solapur", cap: 6000, avail: 3100, cost: 0.95, crops: "Pomegranate,Cotton,Soybean" },
];
...
insLot.run("LOT-2026-0031", "farmer", "farmer-1", "crop-onion", "Nashik Red N-53", 18, "A", "Niphad", "Nashik", isoDaysAgo(6), isoDaysAgo(2), 2900, 2600, 1, "Open for offers", 0, null);
insLot.run("LOT-2026-0032", "farmer", "farmer-2", "crop-onion", "Nashik Red N-53", 12, "B", "Lasalgaon", "Nashik", isoDaysAgo(4), isoDaysAgo(1), 2650, 2400, 0, "Open for offers", 0, null);
insLot.run("LOT-2026-0033", "farmer", "farmer-1", "crop-grapes", "Thompson Seedless", 6, "A", "Niphad", "Nashik", isoDaysAgo(2), isoDaysAgo(1), 5400, 5000, 1, "Under negotiation", 0, null);
insLot.run("LOT-2026-0048", "fpo", "fpo-1", "crop-onion", "Nashik Red N-53", 120, "A", "Niphad", "Nashik", isoDaysAgo(5), isoDaysAgo(2), 3000, 2750, 1, "Open for offers", 1, JSON.stringify(["LOT-2026-0031", "LOT-2026-0032"]));
insLot.run("LOT-2026-0050", "farmer", "farmer-extra-0", "crop-soybean", "JS-335", 25, "B", "Niphad", "Nashik", isoDaysAgo(10), isoDaysAgo(5), 4300, 4000, 0, "Sold", 0, null);
...
insDemand.run("DEM-1001", "buyer-1", "crop-onion", 100, "A", isoDaysFromNow(10), 3050, "Pune", "Open");
insDemand.run("DEM-1002", "buyer-5", "crop-onion", 50, "B", isoDaysFromNow(7), 2700, "Pune", "Open");
insDemand.run("DEM-1003", "buyer-2", "crop-tomato", 500, "A", isoDaysFromNow(14), 2900, "Pune", "Open");
insDemand.run("DEM-1004", "buyer-3", "crop-grapes", 40, "A", isoDaysFromNow(5), 5600, "Nashik", "Open");
insDemand.run("DEM-1005", "buyer-4", "crop-onion", 20, "C", isoDaysFromNow(3), 2300, "Solapur", "Open");
...
insLogi.run("LOG-4001", "TXN-3001", "Niphad, Nashik", "Solapur", 25, 200, 200 * 1.05, "Open truck 6-tonne", isoDaysAgo(4), isoDaysAgo(3), "Delivered", "MH15-AB-4521");
insLogi.run("LOG-4002", "TXN-3002", "Lasalgaon, Nashik", "Solapur", 12, 200, 200 * 1.05, "Open truck 6-tonne", isoDaysAgo(2), isoDaysAgo(1), "Delivered", "MH15-CD-7788");
...
insNotif.run(id("notif"), "user-farmer1", "New offer received on LOT-2026-0031 from Maharashtra Agro Foods Pvt Ltd.", 0);
insNotif.run(id("notif"), "user-farmer2", "Your grievance GRV-6001 is now Under Review.", 0);
insNotif.run(id("notif"), "user-fpo1", "New offer received on LOT-2026-0048 from AgriBazaar Digital Trading.", 0);

console.log("Seed complete.");
console.log("Demo logins (password 'demo123' for all): farmer1, farmer2, fpo1, buyer1, buyer2, admin1");
